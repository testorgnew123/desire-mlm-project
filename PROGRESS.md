...
- [ ] **GATE** Upgrade off the free tier — background functions, 10 GB, 7-day PITR, region `sin` · **BLOCKED#14** (billing decision, not code)
- [ ] Move Neon to `ap-southeast-1` and Netlify functions to `sin` after upgrade · blocked on BLOCKED#14
...
- [ ] Effective-dated `TaxRate` seeded with confirmed values · **BLOCKED#11** — PLACEHOLDER rates seeded (SEC_192/194J/194H) so `prepareBatch` is demoable; real values need CA sign-off
