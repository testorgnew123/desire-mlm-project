...
| | |
|---|---|
| **Current phase** | **Phase 2 — Sales & Collections, 9/23 done** (Booking Core, discount routing, cancellation + clawback preview, CRM, payment plans + demand generation). Phase 2 is scoped as a sequence of slices, not one pass — this is Slices 1–4; the roadmap for what follows (receipts + the maker-checker verify GATE, escalation + notifications) is recorded in the Decision log. Phases 0 and 1 are both **complete** (17/17 each). **CI is green.** Phase 3's pure engine built ahead of order — risk-first sequencing, see Decision log |
| **Started** | 2026-09-05 |
...
| 2 — Sales & Collections | 23 | 9 | **1/2** | In progress — Slices 1-4 (booking core + discount + cancellation + CRM + demands) |
